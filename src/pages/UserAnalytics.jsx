  ...
  return (
    <div style={{ padding: '0 0 32px 0', backgroundColor: '#f8fafc', minHeight: '100vh', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{
          display: 'grid',
          gridTemplateColumns: isMobile ? 'repeat(auto-fit, minmax(220px, 1fr))' : (showUsersCard ? 'repeat(5, 1fr)' : 'repeat(4, 1fr)'),
          gap: '16px',
          marginBottom: '16px'
        }}>
          {loading ? (
            <>
              {showUsersCard && <MetricCardSkeleton />}
              <MetricCardSkeleton />
            ...
            <>
              {/* Card 1: Users - hidden for tenant_user or when a specific user is selected */}
              {showUsersCard && (
