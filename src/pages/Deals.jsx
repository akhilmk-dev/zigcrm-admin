  ...
  return (
    <div>
      ...
      <div className="filter-bar" style={{ borderRadius: '6px' }}>
        ...
        {/* Stage Filter */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <span style={{ fontSize: '13px', fontWeight: '600', color: '#374151' }}>Stage</span>
          <div style={{ position: 'relative', display: 'inline-block' }}>
            <select
              value={stageFilter}
        ...
        actions={(row) => (
          <>
            {hasPermission('deals.update') && (
              <Button type="secondary" size="sm" onClick={() => handleOpenModal(row)} title="Edit Deal" style={{ padding: '6px 8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
              </Button>
            )}
            {hasPermission('deals.delete') && (
              <Button type="ghost" size="sm" onClick={() => handleDelete(row)} title="Delete Deal" style={{ padding: '6px 8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
